...
public class UI {
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		...
		if (chessMatch.getCheck() == true) {
			System.out.println("O rei " + chessMatch.getCurrentPlayer() + " esta em xeque");
		}
	}
	...
	public static void printCapturedPieces(List<ChessPiece> captured) {
		...
		System.out.print("Brancas: " + Arrays.toString(white.toArray()));
		System.out.print(ANSI_RESET);
		System.out.println();
		System.out.print(ANSI_YELLOW);
		System.out.print("Pretas: " + Arrays.toString(black.toArray()));
		System.out.print(ANSI_RESET);
	}
}
