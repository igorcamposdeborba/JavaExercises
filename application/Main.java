		...
		do {
			...
			while (game.verifyHorizontal() == false && game.verifyVertical() == false && game.verifyDiagonal() == false) {
				...
				if (turnPlayer1 == true) {
					...
					boolean result = game.play(linePlayer1 - 1, columnPlayer1 - 1, 'x'); // tratar dado: diminui 1 porque o array começa em zero
					...
					boolean result = game.play(linePlayer2 - 1, columnPlayer2 - 1, 'o'); // formatar para começar de 1 e não zero
				}
			}
			game.printBoard();
